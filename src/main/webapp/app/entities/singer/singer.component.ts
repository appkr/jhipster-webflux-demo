...
export default class Singer extends Vue {
  ...
  public retrieveAllSingers(): void {
  ...
  public prepareRemove(instance: ISinger): void {
  ...
  public removeSinger(): void {
    this.singerService()
      .delete(this.removeId)
      .then(() => {
        const message = 'A Singer is deleted with identifier ' + this.removeId;
