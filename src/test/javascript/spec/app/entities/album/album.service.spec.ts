...
describe('Service Tests', () => {
  describe('Album Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Album(0, 'AAAAAAA', currentDate);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Album', async () => {
      ...
      it('should not update a Album', async () => {
      ...
      it('should partial update a Album', async () => {
      ...
      it('should not partial update a Album', async () => {
      ...
      it('should not return a list of Album', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Album', async () => {
